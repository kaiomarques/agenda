...
@section('content')
    ...
    <hr>
    {!! Form::open([
        'route' => 'justificativa.store'
    ]) !!}

    <div class="form-group">
        <div style="width:50%">
        	{!! Form::label('id_tributo', 'Tributo', ['class' => 'control-label'] )  !!}
        	{!!  Form::select('id_tributo', $array, array(), ['class' => 'form-control']) !!}
        </div>
    </div>
	...
	<div class="form-group">
        <div style="width:50%">
			...
			{!! Form::text('periodo_apuracao',null, ['class' => 'form-control','style' => 'width:80px', 'maxlength' => 7]) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        <div style="width:180px">
            ...
            {!! Form::text('justificativa', null, ['class' => 'form-control', 'style' => 'width:480px', 'maxlength' => 60]) !!}
        </div>
    </div>
